...
class LoginLogger {
    ...
    public void logStartLogin(Request request) {
        ...
        try {
            ...
            jSONObject.put(EVENT_EXTRAS_PERMISSIONS, TextUtils.join(",", request.getPermissions()));
            jSONObject.put(EVENT_EXTRAS_DEFAULT_AUDIENCE, request.getDefaultAudience().toString());
