...
public final class AccessToken implements Parcelable {
    ...
    static class C04851 implements GraphMeRequestWithCacheCallback {
        final /* synthetic */ AccessTokenCreationCallback val$accessTokenCallback;
        final /* synthetic */ String val$applicationId;
        final /* synthetic */ Bundle val$extras;

        C04851(Bundle bundle, AccessTokenCreationCallback accessTokenCreationCallback, String str) {
        ...
        public void onSuccess(JSONObject jSONObject) {
            try {
                this.val$extras.putString(AccessToken.USER_ID_KEY, jSONObject.getString(ShareConstants.WEB_DIALOG_PARAM_ID));
    ...
    static class C04862 implements Creator {
        C04862() {
        }
    ...
    public static void createFromNativeLinkingIntent(Intent intent, String str, AccessTokenCreationCallback accessTokenCreationCallback) {
        ...
        if (string2 == null || string2.isEmpty()) {
            Utility.getGraphMeRequestWithCacheAsync(string, new C04851(bundle, accessTokenCreationCallback, str));
        } else {
    ...
    static AccessToken createFromJSONObject(JSONObject jSONObject) throws JSONException {
        ...
        return new AccessToken(string, jSONObject.getString(APPLICATION_ID_KEY), jSONObject.getString(USER_ID_KEY), Utility.jsonArrayToStringList(jSONArray), Utility.jsonArrayToStringList(jSONArray2), AccessTokenSource.valueOf(jSONObject.getString(SOURCE_KEY)), date, date2);
    }
