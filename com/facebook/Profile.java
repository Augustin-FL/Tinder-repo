...
public final class Profile implements Parcelable {
    ...
    static class C05041 implements GraphMeRequestWithCacheCallback {
        C05041() {
        }

        public void onSuccess(JSONObject jSONObject) {
            String optString = jSONObject.optString(Profile.ID_KEY);
            if (optString != null) {
    ...
    static class C05052 implements Creator {
        C05052() {
        }
    ...
    public static void fetchProfileForCurrentAccessToken() {
        ...
        if (currentAccessToken == null) {
            ...
            Utility.getGraphMeRequestWithCacheAsync(currentAccessToken.getToken(), new C05041());
        }
    }

    public Profile(String str, @Nullable String str2, @Nullable String str3, @Nullable String str4, @Nullable String str5, @Nullable Uri uri) {
        Validate.notNullOrEmpty(str, ID_KEY);
        this.id = str;
        this.firstName = str2;
