...
public class ImageDownloader {
    ...
    static class C05441 implements Runnable {
        ...
        C05441(ImageRequest imageRequest, Exception exception, boolean z, Bitmap bitmap, Callback callback) {
    ...
    private static void issueResponse(RequestKey requestKey, Exception exception, Bitmap bitmap, boolean z) {
        ...
        if (removePendingRequest != null && !removePendingRequest.isCancelled) {
            ...
            if (callback != null) {
                getHandler().post(new C05441(imageRequest, exception, z, bitmap, callback));
            }
        }
    }
    ...
    L_0x00a5:
        ...
        throw r0;
    L_0x00ac:
        r4 = com.facebook.C0508R.string.com_facebook_image_download_unknown_error;	 Catch:{ IOException -> 0x0040, all -> 0x00a0 }
