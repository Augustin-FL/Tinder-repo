...
public final class Utility {
    ...
    static class C05491 implements Runnable {
        ...
        C05491(String str, Context context, String str2) {
    ...
    static class C05502 implements Callback {
        final /* synthetic */ String val$accessToken;
        final /* synthetic */ GraphMeRequestWithCacheCallback val$callback;

        C05502(GraphMeRequestWithCacheCallback graphMeRequestWithCacheCallback, String str) {
    ...
    static class C05513 implements FilenameFilter {
        C05513() {
        }
    ...
    public static class DialogFeatureConfig {
        ...
        private static DialogFeatureConfig parseDialogConfig(JSONObject jSONObject) {
            ...
            optString = jSONObject.optString(Utility.DIALOG_CONFIG_URL_KEY);
            if (!Utility.isNullOrEmpty(optString)) {
    ...
    static {
        APP_SETTING_FIELDS = new String[]{APP_SETTING_SUPPORTS_IMPLICIT_SDK_LOGGING, APP_SETTING_NUX_CONTENT, APP_SETTING_NUX_ENABLED, APP_SETTING_DIALOG_CONFIGS, APP_SETTING_ANDROID_SDK_ERROR_CATEGORIES};
        ...
        deviceTimezone = BuildConfig.FLAVOR;
    ...
    public static void loadAppSettingsAsync(Context context, String str) {
        ...
        if (!isNullOrEmpty(str) && !fetchedAppSettings.containsKey(str) && compareAndSet) {
            ...
            FacebookSdk.getExecutor().execute(new C05491(str, context, format));
    ...
    private static FetchedAppSettings parseAppSettingsFromJSON(String str, JSONObject jSONObject) {
        ...
        FetchedAppSettings fetchedAppSettings = new FetchedAppSettings(jSONObject.optString(APP_SETTING_NUX_CONTENT, BuildConfig.FLAVOR), jSONObject.optBoolean(APP_SETTING_NUX_ENABLED, false), parseDialogConfigurations(jSONObject.optJSONObject(APP_SETTING_DIALOG_CONFIGS)), defaultErrorClassification, null);
    ...
    public static void getGraphMeRequestWithCacheAsync(String str, GraphMeRequestWithCacheCallback graphMeRequestWithCacheCallback) {
        ...
        Callback c05502 = new C05502(graphMeRequestWithCacheCallback, str);
        GraphRequest graphMeRequestWithCache = getGraphMeRequestWithCache(str);
        graphMeRequestWithCache.setCallback(c05502);
    ...
    private static GraphRequest getGraphMeRequestWithCache(String str) {
        ...
        bundle.putString(ServerProtocol.DIALOG_PARAM_ACCESS_TOKEN, str);
    ...
    private static int refreshBestGuessNumberOfCPUCores() {
        ...
        if (VERSION.SDK_INT <= GINGERBREAD_MR1) {
            numCPUCores = 1;
            return numCPUCores;
        }
        try {
            numCPUCores = new File("/sys/devices/system/cpu/").listFiles(new C05513()).length;
        } catch (Exception e) {
        }
        if (numCPUCores <= 0) {
