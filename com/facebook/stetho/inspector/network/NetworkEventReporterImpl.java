...
public class NetworkEventReporterImpl implements NetworkEventReporter {
    ...
    public void responseHeadersReceived(InspectorResponse inspectorResponse) {
        ...
        if (peerManagerIfEnabled != null) {
            ...
            response.mimeType = contentType != null ? getResourceTypeHelper().stripContentExtras(contentType) : HTTP.OCTET_STREAM_TYPE;
            ...
            responseReceivedParams.type = contentType != null ? getResourceTypeHelper().determineResourceType(contentType) : ResourceType.OTHER;
    ...
    private String getContentType(InspectorHeaders inspectorHeaders) {
        return inspectorHeaders.firstHeaderValue(HTTP.CONTENT_TYPE);
    }
