...
public class AppLinkData {
    ...
    static class C05191 implements Runnable {
        ...
        C05191(Context context, String str, CompletionHandler completionHandler) {
    ...
    public static void fetchDeferredAppLinkData(Context context, String str, CompletionHandler completionHandler) {
        ...
        FacebookSdk.getExecutor().execute(new C05191(context.getApplicationContext(), str, completionHandler));
    }
