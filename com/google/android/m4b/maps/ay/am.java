...
public final class am {
    public static int m1577a(DataInput dataInput) {
    ...
    public static void m1578a(DataOutput dataOutput, int i) {
        if (i < 0) {
    ...
    public static int m1579b(DataInput dataInput) {
        int a = m1577a(dataInput);
        return (-(a & 1)) ^ (a >>> 1);
    }
}
