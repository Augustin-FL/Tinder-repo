...
public final class C1568a {
    ...
    private static void m2785a(byte[] bArr, int i, int i2, int i3, int i4) {
        System.arraycopy(C1570c.m2791a(i2, i3, i4), 0, bArr, i, 64);
    }

    public static int m2784a(byte[] bArr, int i, int i2, int i3, int i4, int i5, int i6) {
        if (i2 != 0) {
            ...
            System.arraycopy(f1767a, 0, bArr, i, 623);
            int i7 = i + 163;
            bArr[i7] = (byte) (i3 >> 8);
            bArr[i7 + 1] = (byte) (i3 & RangeSeekBar.INVALID_POINTER_ID);
            bArr[i7 + 2] = (byte) (i4 >> 8);
            bArr[i7 + 3] = (byte) (i4 & RangeSeekBar.INVALID_POINTER_ID);
            if (i5 != 75) {
                int i8 = i + 94;
                C1568a.m2785a(bArr, i + 25, 0, i5, i6);
                C1568a.m2785a(bArr, i8, 1, i5, i6);
            }
            return 623;
        } else {
