...
public final class DataHolder implements SafeParcelable {
    ...
    static class C08111 extends zza {
        C08111(String[] strArr, String str) {
            super(str, null);
        }
    }
    ...
    static {
        CREATOR = new zze();
        zzabs = new C08111(new String[0], null);
    }
    ...
    private DataHolder(zza com_google_android_gms_common_data_DataHolder_zza, int i, Bundle bundle) {
        this(com_google_android_gms_common_data_DataHolder_zza.zzabk, zza(com_google_android_gms_common_data_DataHolder_zza, -1), i, bundle);
    }
    ...
    public DataHolder(String[] strArr, CursorWindow[] cursorWindowArr, int i, Bundle bundle) {
        ...
        this.mVersionCode = 1;
        this.zzabk = (String[]) zzx.zzv(strArr);
        this.zzabm = (CursorWindow[]) zzx.zzv(cursorWindowArr);
        this.zzWu = i;
        this.zzabn = bundle;
        zznT();
    }
