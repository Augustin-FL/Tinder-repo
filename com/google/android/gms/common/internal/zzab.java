...
public final class zzab extends Button {
    ...
    private void zzb(Resources resources, int i, int i2) {
        ...
        switch (i) {
            ...
            case C3374b.SmoothProgressBar_spb_color /*1*/:
                zzd = zzd(i2, C0708R.drawable.common_signin_btn_text_dark, C0708R.drawable.common_signin_btn_text_light);
                break;
            case C3374b.SmoothProgressBar_spb_stroke_width /*2*/:
                zzd = zzd(i2, C0708R.drawable.common_signin_btn_icon_dark, C0708R.drawable.common_signin_btn_icon_light);
                break;
            default:
    ...
    private void zzc(Resources resources, int i, int i2) {
        setTextColor(resources.getColorStateList(zzd(i2, C0708R.color.common_signin_btn_text_dark, C0708R.color.common_signin_btn_text_light)));
        switch (i) {
            case C3374b.SmoothProgressBar_spbStyle /*0*/:
                setText(resources.getString(C0708R.string.common_signin_button_text));
            case C3374b.SmoothProgressBar_spb_color /*1*/:
                setText(resources.getString(C0708R.string.common_signin_button_text_long));
            case C3374b.SmoothProgressBar_spb_stroke_width /*2*/:
                setText(null);
            default:
                throw new IllegalStateException("Unknown button size: " + i);
