...
public final class zzk implements Callback {
    ...
    public boolean isConnectionCallbacksRegistered(ConnectionCallbacks connectionCallbacks) {
        ...
        synchronized (this.zzpc) {
            contains = this.zzadN.contains(connectionCallbacks);
        }
        return contains;
    }
    ...
    public boolean isConnectionFailedListenerRegistered(OnConnectionFailedListener onConnectionFailedListener) {
        ...
        synchronized (this.zzpc) {
            contains = this.zzadP.contains(onConnectionFailedListener);
        }
        return contains;
    }
    ...
    public void registerConnectionCallbacks(ConnectionCallbacks connectionCallbacks) {
        ...
        synchronized (this.zzpc) {
            if (this.zzadN.contains(connectionCallbacks)) {
                ...
                this.zzadN.add(connectionCallbacks);
            }
        }
    ...
    public void registerConnectionFailedListener(OnConnectionFailedListener onConnectionFailedListener) {
        ...
        synchronized (this.zzpc) {
            if (this.zzadP.contains(onConnectionFailedListener)) {
                ...
                this.zzadP.add(onConnectionFailedListener);
            }
        }
    }
    ...
    public void unregisterConnectionCallbacks(ConnectionCallbacks connectionCallbacks) {
        zzx.zzv(connectionCallbacks);
        synchronized (this.zzpc) {
            if (!this.zzadN.remove(connectionCallbacks)) {
                Log.w("GmsClientEvents", "unregisterConnectionCallbacks(): listener " + connectionCallbacks + " not found");
            } else if (this.zzadS) {
                this.zzadO.add(connectionCallbacks);
            }
        }
    }
