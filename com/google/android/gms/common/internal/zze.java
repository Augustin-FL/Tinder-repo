...
public abstract class zze {
    ...
    static class C08131 extends zze {
        C08131() {
        }
    ...
    static class C08142 extends zze {
        final /* synthetic */ char zzacV;
        final /* synthetic */ char zzacW;

        C08142(char c, char c2) {
            this.zzacV = c;
            this.zzacW = c2;
        }
    ...
    static class C08153 extends zze {
    ...
    static class C08164 extends zze {
        final /* synthetic */ char zzacY;
        final /* synthetic */ char zzacZ;

        C08164(char c, char c2) {
            this.zzacY = c;
            this.zzacZ = c2;
        }
    ...
    static class C08175 extends zze {
        C08175() {
        }
    ...
    static class C08186 extends zze {
        C08186() {
        }
    ...
    static class C08197 extends zze {
        C08197() {
        }
    ...
    static class C08208 extends zze {
        C08208() {
        }
    ...
    static class C08219 extends zze {
        C08219() {
        }
    ...
    public static zze zza(CharSequence charSequence) {
        switch (charSequence.length()) {
            ...
            case C3374b.SmoothProgressBar_spb_stroke_width /*2*/:
                return new C08142(charSequence.charAt(0), charSequence.charAt(1));
            default:
                char[] toCharArray = charSequence.toString().toCharArray();
                Arrays.sort(toCharArray);
                return new C08153(toCharArray);
        }
    }
