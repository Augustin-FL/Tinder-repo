...
public class zzg implements zzj {
    ...
    class C07981 implements Runnable {
        ...
        C07981(zzg com_google_android_gms_common_api_zzg) {
    ...
    private static class zza extends com.google.android.gms.signin.internal.zzb {
        ...
        class C07991 extends zzb {
            final /* synthetic */ zzg zzZM;
            final /* synthetic */ ConnectionResult zzZN;
            final /* synthetic */ zza zzZO;

            C07991(zza com_google_android_gms_common_api_zzg_zza, zzj com_google_android_gms_common_api_zzj, zzg com_google_android_gms_common_api_zzg, ConnectionResult connectionResult) {
        ...
        public void zza(ConnectionResult connectionResult, AuthAccountResult authAccountResult) {
            ...
            if (com_google_android_gms_common_api_zzg != null) {
                com_google_android_gms_common_api_zzg.zzZq.zza(new C07991(this, com_google_android_gms_common_api_zzg, com_google_android_gms_common_api_zzg, connectionResult));
            }
        }
    }
    ...
    private static class zzb extends com.google.android.gms.common.internal.zzt.zza {
        ...
        class C08001 extends zzb {
            final /* synthetic */ zzg zzZM;
            final /* synthetic */ ResolveAccountResponse zzZP;
            final /* synthetic */ zzb zzZQ;

            C08001(zzb com_google_android_gms_common_api_zzg_zzb, zzj com_google_android_gms_common_api_zzj, zzg com_google_android_gms_common_api_zzg, ResolveAccountResponse resolveAccountResponse) {
        ...
        public void zzb(ResolveAccountResponse resolveAccountResponse) {
            zzg com_google_android_gms_common_api_zzg = (zzg) this.zzZL.get();
            if (com_google_android_gms_common_api_zzg != null) {
                com_google_android_gms_common_api_zzg.zzZq.zza(new C08001(this, com_google_android_gms_common_api_zzg, com_google_android_gms_common_api_zzg, resolveAccountResponse));
            }
        }
    }
    ...
    private class zze extends zzi {
        ...
        class C08011 extends zzb {
            final /* synthetic */ ConnectionResult zzZU;
            final /* synthetic */ zze zzZV;

            C08011(zze com_google_android_gms_common_api_zzg_zze, zzj com_google_android_gms_common_api_zzj, ConnectionResult connectionResult) {
        ...
        public void zznn() {
            ...
            if (isGooglePlayServicesAvailable != 0) {
                this.zzZK.zzZq.zza(new C08011(this, this.zzZK, new ConnectionResult(isGooglePlayServicesAvailable, null)));
                return;
            }
            if (this.zzZK.zzZC) {
    ...
    private void zznt() {
        this.zzZq.zznA();
        zzk.zznF().execute(new C07981(this));
        if (this.zzZA != null) {
            if (this.zzZF) {
