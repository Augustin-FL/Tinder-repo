...
final class zzi implements GoogleApiClient {
    ...
    class C08021 implements zzd {
        final /* synthetic */ zzi zzaap;

        C08021(zzi com_google_android_gms_common_api_zzi) {
    ...
    class C08032 implements ConnectionCallbacks {
        ...
        C08032(zzi com_google_android_gms_common_api_zzi) {
            this.zzaap = com_google_android_gms_common_api_zzi;
        }
        ...
        public void onConnectionSuspended(int i) {
            this.zzaap.zzZs.lock();
            try {
                this.zzaap.zzaai.onConnectionSuspended(i);
            } finally {
                this.zzaap.zzZs.unlock();
            }
        }
    ...
    class C08043 implements com.google.android.gms.common.internal.zzk.zza {
        final /* synthetic */ zzi zzaap;

        C08043(zzi com_google_android_gms_common_api_zzi) {
            this.zzaap = com_google_android_gms_common_api_zzi;
        }
    ...
    class C08054 implements OnConnectionFailedListener {
        final /* synthetic */ zzi zzaap;
        final /* synthetic */ Api zzaaq;
        final /* synthetic */ int zzaar;

        C08054(zzi com_google_android_gms_common_api_zzi, Api api, int i) {
            this.zzaap = com_google_android_gms_common_api_zzi;
            this.zzaaq = api;
            this.zzaar = i;
        }
    ...
    class C08065 implements ConnectionCallbacks {
        final /* synthetic */ zzi zzaap;
        final /* synthetic */ AtomicReference zzaas;
        final /* synthetic */ zzo zzaat;

        C08065(zzi com_google_android_gms_common_api_zzi, AtomicReference atomicReference, zzo com_google_android_gms_common_api_zzo) {
            this.zzaap = com_google_android_gms_common_api_zzi;
    ...
    class C08076 implements OnConnectionFailedListener {
        final /* synthetic */ zzi zzaap;
        final /* synthetic */ zzo zzaat;

        C08076(zzi com_google_android_gms_common_api_zzi, zzo com_google_android_gms_common_api_zzo) {
            this.zzaap = com_google_android_gms_common_api_zzi;
            this.zzaat = com_google_android_gms_common_api_zzo;
        }
    ...
    class C08087 implements ResultCallback<Status> {
        final /* synthetic */ GoogleApiClient zzVc;
        final /* synthetic */ zzi zzaap;
        final /* synthetic */ zzo zzaat;
        final /* synthetic */ boolean zzaau;

        C08087(zzi com_google_android_gms_common_api_zzi, zzo com_google_android_gms_common_api_zzo, boolean z, GoogleApiClient googleApiClient) {
            this.zzaap = com_google_android_gms_common_api_zzi;
            this.zzaat = com_google_android_gms_common_api_zzo;
            this.zzaau = z;
    ...
    class C08098 implements Runnable {
        final /* synthetic */ zzi zzaap;
        final /* synthetic */ FragmentActivity zzaav;

        C08098(zzi com_google_android_gms_common_api_zzi, FragmentActivity fragmentActivity) {
            this.zzaap = com_google_android_gms_common_api_zzi;
    ...
    public zzi(Context context, Looper looper, zzf com_google_android_gms_common_internal_zzf, GoogleApiAvailability googleApiAvailability, com.google.android.gms.common.api.Api.zza<? extends com.google.android.gms.signin.zzd, com.google.android.gms.signin.zze> com_google_android_gms_common_api_Api_zza__extends_com_google_android_gms_signin_zzd__com_google_android_gms_signin_zze, Map<Api<?>, ApiOptions> map, ArrayList<ConnectionCallbacks> arrayList, ArrayList<OnConnectionFailedListener> arrayList2, int i, int i2) {
        ...
        this.zzaam = new C08021(this);
        this.zzaan = new C08032(this);
        this.zzaao = new C08043(this);
    ...
    private void zza(GoogleApiClient googleApiClient, zzo com_google_android_gms_common_api_zzo, boolean z) {
        zzkw.zzaet.zzc(googleApiClient).setResultCallback(new C08087(this, com_google_android_gms_common_api_zzo, z, googleApiClient));
    }
    ...
    public PendingResult<Status> clearDefaultAccountAndReconnect() {
        ...
        if (this.zzaaf.containsKey(zzkw.zzQf)) {
            ...
            ConnectionCallbacks c08065 = new C08065(this, atomicReference, com_google_android_gms_common_api_zzo);
            GoogleApiClient build = new Builder(this.mContext).addApi(zzkw.API).addConnectionCallbacks(c08065).addOnConnectionFailedListener(new C08076(this, com_google_android_gms_common_api_zzo)).setHandler(this.zzaad).build();
    ...
    public void stopAutoManage(FragmentActivity fragmentActivity) {
        if (this.zzZf >= 0) {
            ...
            if (zza == null) {
                new Handler(this.mContext.getMainLooper()).post(new C08098(this, fragmentActivity));
            } else {
                zza.zzbi(this.zzZf);
            }
        } else if (this.zzZg >= 0) {
