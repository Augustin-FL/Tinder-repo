...
public class zzc extends zzi implements OnAudioFocusChangeListener, OnBufferingUpdateListener, OnCompletionListener, OnErrorListener, OnInfoListener, OnPreparedListener, OnVideoSizeChangedListener, SurfaceTextureListener {
    ...
    class C07201 implements Runnable {
        ...
        C07201(zzc com_google_android_gms_ads_internal_overlay_zzc) {
    ...
    class C07212 implements Runnable {
        ...
        C07212(zzc com_google_android_gms_ads_internal_overlay_zzc) {
            this.zzAr = com_google_android_gms_ads_internal_overlay_zzc;
        }
    ...
    class C07223 implements Runnable {
        ...
        C07223(zzc com_google_android_gms_ads_internal_overlay_zzc, String str, String str2) {
            this.zzAr = com_google_android_gms_ads_internal_overlay_zzc;
            this.zzAs = str;
            this.zzAt = str2;
        }
    ...
    class C07234 implements Runnable {
        ...
        C07234(zzc com_google_android_gms_ads_internal_overlay_zzc) {
            this.zzAr = com_google_android_gms_ads_internal_overlay_zzc;
        }
    ...
    class C07245 implements Runnable {
        ...
        C07245(zzc com_google_android_gms_ads_internal_overlay_zzc) {
            this.zzAr = com_google_android_gms_ads_internal_overlay_zzc;
        }
    ...
    class C07256 implements Runnable {
        ...
        C07256(zzc com_google_android_gms_ads_internal_overlay_zzc) {
            this.zzAr = com_google_android_gms_ads_internal_overlay_zzc;
        }
    ...
    class C07267 implements Runnable {
        ...
        C07267(zzc com_google_android_gms_ads_internal_overlay_zzc) {
            this.zzAr = com_google_android_gms_ads_internal_overlay_zzc;
        }
    ...
    private void zzel() {
        Throwable e;
        zzb.m1002v("AdVideoView init MediaPlayer");
    ...
    private void zzem() {
        if (zzep() && this.zzAf.getCurrentPosition() > 0 && this.zzAe != 3) {
            zzb.m1002v("AdVideoView nudging MediaPlayer");
            zzb(0.0f);
            this.zzAf.start();
    ...
    private void zzeo() {
        zzb.m1002v("AdVideoView abandon audio focus");
        AudioManager zzev = zzev();
        if (zzev != null && this.zzAo) {
    ...
    private void zzes() {
        zzb.m1002v("AdVideoView audio focus gained");
        this.zzAo = true;
        zzeu();
    }

    private void zzet() {
        zzb.m1002v("AdVideoView audio focus lost");
        this.zzAo = false;
        zzeu();
    }
    ...
    private void zzt(boolean z) {
        zzb.m1002v("AdVideoView release");
        if (this.zzAf != null) {
            this.zzAf.reset();
            this.zzAf.release();
            this.zzAf = null;
    ...
    public void onCompletion(MediaPlayer mediaPlayer) {
        zzb.m1002v("AdVideoView completion");
        zzt(5);
        zzu(5);
        zzhu.zzHK.post(new C07212(this));
    }

    public boolean onError(MediaPlayer mediaPlayer, int i, int i2) {
        String str = (String) zzAb.get(Integer.valueOf(i));
        String str2 = (String) zzAb.get(Integer.valueOf(i2));
        zzb.zzaE("AdVideoView MediaPlayer error: " + str + ":" + str2);
        zzt(-1);
        zzu(-1);
        zzhu.zzHK.post(new C07223(this, str, str2));
        return true;
    }

    public boolean onInfo(MediaPlayer mediaPlayer, int i, int i2) {
        String str = (String) zzAb.get(Integer.valueOf(i2));
        zzb.m1002v("AdVideoView MediaPlayer info: " + ((String) zzAb.get(Integer.valueOf(i))) + ":" + str);
        return true;
    }
    ...
    protected void onMeasure(int i, int i2) {
        ...
        if (this.zzAh > 0 && this.zzAi > 0) {
            ...
            if (mode == 1073741824 && mode2 == 1073741824) {
                ...
                if (mode2 != Action.UNDEFINED_DURATION || defaultSize <= defaultSize2) {
                ...
                defaultSize = (this.zzAh * defaultSize2) / this.zzAi;
                if (mode == Action.UNDEFINED_DURATION && defaultSize > size) {
                    defaultSize = size;
                }
            } else {
                int i3 = this.zzAh;
                ...
                if (mode == Action.UNDEFINED_DURATION && r1 > size) {
                    defaultSize2 = (this.zzAi * size) / this.zzAh;
                    defaultSize = size;
                }
            }
    ...
    public void onPrepared(MediaPlayer mediaPlayer) {
        zzb.m1002v("AdVideoView prepared");
        zzt(2);
        this.zzAc.zzeL();
        zzhu.zzHK.post(new C07201(this));
    ...
    public void onSurfaceTextureAvailable(SurfaceTexture surfaceTexture, int i, int i2) {
        zzb.m1002v("AdVideoView surface created");
        zzel();
        zzhu.zzHK.post(new C07234(this));
    }

    public boolean onSurfaceTextureDestroyed(SurfaceTexture surfaceTexture) {
        zzb.m1002v("AdVideoView surface destroyed");
        if (this.zzAf != null && this.zzAp == 0) {
            this.zzAp = this.zzAf.getCurrentPosition();
        }
        zzhu.zzHK.post(new C07245(this));
        zzt(true);
        return true;
    }
    ...
    public void onSurfaceTextureSizeChanged(SurfaceTexture surfaceTexture, int i, int i2) {
        Object obj = 1;
        zzb.m1002v("AdVideoView surface changed");
        Object obj2 = this.zzAe == 3 ? 1 : null;
        if (!(this.zzAh == i && this.zzAi == i2)) {
            obj = null;
        }
    ...
    public void onVideoSizeChanged(MediaPlayer mediaPlayer, int i, int i2) {
        zzb.m1002v("AdVideoView size changed: " + i + " x " + i2);
        this.zzAh = mediaPlayer.getVideoWidth();
        this.zzAi = mediaPlayer.getVideoHeight();
        if (this.zzAh != 0 && this.zzAi != 0) {
            requestLayout();
    ...
    public void pause() {
        zzb.m1002v("AdVideoView pause");
        if (zzep() && this.zzAf.isPlaying()) {
            this.zzAf.pause();
            zzt(4);
            zzhu.zzHK.post(new C07267(this));
        }
        zzu(4);
    }

    public void play() {
        zzb.m1002v("AdVideoView play");
        if (zzep()) {
            this.zzAf.start();
            zzt(3);
            zzhu.zzHK.post(new C07256(this));
        }
        zzu(3);
    }

    public void seekTo(int i) {
        zzb.m1002v("AdVideoView seek " + i);
        if (zzep()) {
            this.zzAf.seekTo(i);
            this.zzAp = 0;
            return;
