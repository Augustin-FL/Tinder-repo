...
public class zzd extends com.google.android.gms.internal.zzfe.zza implements zzo {
    ...
    class C07271 implements com.google.android.gms.internal.zziq.zza {
        final /* synthetic */ zzd zzAL;

        C07271(zzd com_google_android_gms_ads_internal_overlay_zzd) {
    ...
    protected void zzv(boolean z) throws zza {
        ...
        if (z) {
            ...
            this.zzoL.zzgS().zza(new C07271(this));
            if (this.zzAx.url != null) {
                this.zzoL.loadUrl(this.zzAx.url);
            } else if (this.zzAx.zzAV != null) {
                this.zzoL.loadDataWithBaseURL(this.zzAx.zzAT, this.zzAx.zzAV, "text/html", HTTP.UTF_8, null);
            } else {
