...
public class zzk extends FrameLayout implements zzh {
    ...
    private void zzeV() {
        if (this.zzoL.zzgN() != null && !this.zzBe) {
            this.zzBf = (this.zzoL.zzgN().getWindow().getAttributes().flags & AccessibilityNodeInfoCompat.ACTION_CLEAR_ACCESSIBILITY_FOCUS) != 0;
            if (!this.zzBf) {
                this.zzoL.zzgN().getWindow().addFlags(AccessibilityNodeInfoCompat.ACTION_CLEAR_ACCESSIBILITY_FOCUS);
                this.zzBe = true;
            }
        }
    }
    ...
    private void zzeW() {
        if (this.zzoL.zzgN() != null && this.zzBe && !this.zzBf) {
            this.zzoL.zzgN().getWindow().clearFlags(AccessibilityNodeInfoCompat.ACTION_CLEAR_ACCESSIBILITY_FOCUS);
            this.zzBe = false;
        }
    }
