...
public class zzo {
    ...
    class C07491 implements Runnable {
        ...
        C07491(zzo com_google_android_gms_ads_internal_zzo, WeakReference weakReference) {
    ...
    zzo(zza com_google_android_gms_ads_internal_zza, zza com_google_android_gms_ads_internal_zzo_zza) {
        ...
        this.zzx = new C07491(this, new WeakReference(com_google_android_gms_ads_internal_zza));
    }
