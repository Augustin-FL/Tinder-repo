...
public class zzi {
    ...
    class C07291 implements ServiceConnection {
        final /* synthetic */ zzi zzCn;
        final /* synthetic */ Context zzrn;

        C07291(zzi com_google_android_gms_ads_internal_purchase_zzi, Context context) {
        ...
        public void onServiceConnected(ComponentName componentName, IBinder iBinder) {
            ...
            com_google_android_gms_ads_internal_purchase_zzb.zzM(iBinder);
    ...
    public void zzy(Context context) {
        ServiceConnection c07291 = new C07291(this, context);
        Intent intent = new Intent("com.android.vending.billing.InAppBillingService.BIND");
        intent.setPackage(GooglePlayServicesUtil.GOOGLE_PLAY_STORE_PACKAGE);
        context.bindService(intent, c07291, 1);
    }
}
