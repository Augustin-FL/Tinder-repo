...
public class zzc extends zzhq implements ServiceConnection {
    ...
    class C07281 implements Runnable {
        ...
        C07281(zzc com_google_android_gms_ads_internal_purchase_zzc, zzf com_google_android_gms_ads_internal_purchase_zzf, Intent intent) {
    ...
    private void zzd(long j) {
        do {
            if (!zze(j)) {
                zzb.m1002v("Timeout waiting for pending transaction to be processed.");
            }
        } while (!this.zzBO);
    }
    ...
    protected void zza(zzf com_google_android_gms_ads_internal_purchase_zzf, String str, String str2) {
        ...
        zzhu.zzHK.post(new C07281(this, com_google_android_gms_ads_internal_purchase_zzf, intent));
    }
