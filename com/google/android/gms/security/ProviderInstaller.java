...
public class ProviderInstaller {
    ...
    static class C12331 extends AsyncTask<Void, Void, Integer> {
        final /* synthetic */ ProviderInstallListener zzaNW;
        final /* synthetic */ Context zzrn;

        C12331(Context context, ProviderInstallListener providerInstallListener) {
            this.zzrn = context;
    ...
    public static void installIfNeededAsync(Context context, ProviderInstallListener providerInstallListener) {
        ...
        new C12331(context, providerInstallListener).execute(new Void[0]);
    }
