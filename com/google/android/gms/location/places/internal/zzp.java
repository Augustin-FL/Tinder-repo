...
public class zzp implements PlacePhotoMetadata {
    ...
    class C12071 extends zza<zzd> {
        final /* synthetic */ int zzaEV;
        final /* synthetic */ int zzaEW;
        final /* synthetic */ zzp zzaEX;

        C12071(zzp com_google_android_gms_location_places_internal_zzp, zzc com_google_android_gms_common_api_Api_zzc, GoogleApiClient googleApiClient, int i, int i2) {
    ...
    public PendingResult<PlacePhotoResult> getScaledPhoto(GoogleApiClient googleApiClient, int i, int i2) {
        return googleApiClient.zza(new C12071(this, Places.zzaDN, googleApiClient, i, i2));
    }
