...
public class zzi {
    ...
    private static class zza extends com.google.android.gms.location.zzc.zza {
        ...
        class C11961 extends Handler {
            final /* synthetic */ LocationCallback zzaCG;
            final /* synthetic */ zza zzaCO;

            C11961(zza com_google_android_gms_location_internal_zzi_zza, Looper looper, LocationCallback locationCallback) {
            ...
            public void handleMessage(Message message) {
                switch (message.what) {
                    case C3374b.SmoothProgressBar_spbStyle /*0*/:
                        this.zzaCG.onLocationResult((LocationResult) message.obj);
                    case C3374b.SmoothProgressBar_spb_color /*1*/:
                        this.zzaCG.onLocationAvailability((LocationAvailability) message.obj);
                    default:
                }
            }
        }
        ...
        zza(LocationCallback locationCallback, Looper looper) {
            ...
            this.zzaCN = new C11961(this, looper, locationCallback);
        }
