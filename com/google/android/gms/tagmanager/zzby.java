...
class zzby implements zzau {
    ...
    class zza implements com.google.android.gms.tagmanager.zzcx.zza {
        ...
        public void zzb(zzaq com_google_android_gms_tagmanager_zzaq) {
            this.zzaQS.zzq(com_google_android_gms_tagmanager_zzaq.zzAe());
            zzbg.m1005v("Permanent failure dispatching hitId: " + com_google_android_gms_tagmanager_zzaq.zzAe());
        }
        ...
        public void zzc(zzaq com_google_android_gms_tagmanager_zzaq) {
            ...
            if (zzAf == 0) {
                ...
                this.zzaQS.zzq(com_google_android_gms_tagmanager_zzaq.zzAe());
                zzbg.m1005v("Giving up on failed hitId: " + com_google_android_gms_tagmanager_zzaq.zzAe());
            }
        }
    }
    ...
    class zzb extends SQLiteOpenHelper {
        ...
        public void onOpen(SQLiteDatabase sQLiteDatabase) {
            ...
            if (zza("gtm_hits", sQLiteDatabase)) {
                ...
                sQLiteDatabase.execSQL(zzby.zzMg);
            }
        }
    ...
    private void zzAr() {
        ...
        if (zzAs > 0) {
            List zzjj = zzjj(zzAs);
            zzbg.m1005v("Store full, deleting " + zzjj.size() + " hits to make room.");
    ...
    public void dispatch() {
        zzbg.m1005v("GTM Dispatch running...");
        if (this.zzaQN.zzzX()) {
            List zzjk = zzjk(40);
            if (zzjk.isEmpty()) {
                zzbg.m1005v("...nothing to dispatch");
