...
public class DataLayer {
    ...
    class C12412 implements zza {
        final /* synthetic */ DataLayer zzaPH;

        C12412(DataLayer dataLayer) {
    ...
    DataLayer(zzc com_google_android_gms_tagmanager_DataLayer_zzc) {
        this.zzaPF = com_google_android_gms_tagmanager_DataLayer_zzc;
    ...
    private void zzzO() {
        this.zzaPF.zza(new C12412(this));
    }
