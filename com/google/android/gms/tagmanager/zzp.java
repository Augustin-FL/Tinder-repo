...
public class zzp extends com.google.android.gms.common.api.zzb<ContainerHolder> {
    ...
    class C12671 implements com.google.android.gms.internal.zzqk.zza {
        final /* synthetic */ String zzaPs;
        final /* synthetic */ zzp zzaPt;

        /* renamed from: com.google.android.gms.tagmanager.zzp.1.1 */
        class C12661 implements com.google.android.gms.tagmanager.zzo.zza {
            final /* synthetic */ C12671 zzaPu;
        ...
        C12671(zzp com_google_android_gms_tagmanager_zzp, String str) {
        ...
        public void zza(zzqo com_google_android_gms_internal_zzqo) {
            if (com_google_android_gms_internal_zzqo.getStatus() != Status.zzaaD) {
                zzbg.m1004e("Load request failed for the container " + this.zzaPt.zzaOS);
            ...
            this.zzaPt.zzaPm = new zzo(this.zzaPt.zzaPe, this.zzaPt.zzYV, new Container(this.zzaPt.mContext, this.zzaPt.zzaPe.getDataLayer(), this.zzaPt.zzaOS, com_google_android_gms_internal_zzqo.zzBw().zzBB(), zzBA), new C12661(this));
            this.zzaPt.zza(this.zzaPt.zzaPm);
        }
    }

    /* renamed from: com.google.android.gms.tagmanager.zzp.2 */
    class C12682 implements com.google.android.gms.tagmanager.zzo.zza {
        final /* synthetic */ zzp zzaPt;

        C12682(zzp com_google_android_gms_tagmanager_zzp) {
            this.zzaPt = com_google_android_gms_tagmanager_zzp;
        }
    ...
    class C12693 implements zza {
        final /* synthetic */ zzp zzaPt;
        final /* synthetic */ boolean zzaPv;

        C12693(zzp com_google_android_gms_tagmanager_zzp, boolean z) {
            this.zzaPt = com_google_android_gms_tagmanager_zzp;
            this.zzaPv = z;
        }
            ...
            synchronized (this.zzaPt) {
                if (com_google_android_gms_internal_zzaf_zzj.zziR == null) {
                    if (this.zzaPt.zzaPo.zziR == null) {
                        zzbg.m1004e("Current resource is null; network resource is also null");
                        this.zzaPt.zzR(3600000);
                        return;
                    }
                ...
                zzbg.m1005v("setting refresh time to current time: " + this.zzaPt.zzaOX);
                if (!this.zzaPt.zzzK()) {
    ...
    public void load(String str) {
        this.zzaPl.zza(this.zzaOS, this.zzaPj != -1 ? Integer.valueOf(this.zzaPj) : null, str, new C12671(this, str));
    }
    ...
    protected ContainerHolder zzbg(Status status) {
        ...
        if (status == Status.zzaaG) {
            zzbg.m1004e("timer expired: setting result to failure");
        }
    ...
    public void zzzH() {
        com.google.android.gms.internal.zzqp.zzc zzjc = this.zzaPk.zzjc(this.zzaPj);
        if (zzjc != null) {
            zza(new zzo(this.zzaPe, this.zzYV, new Container(this.mContext, this.zzaPe.getDataLayer(), this.zzaOS, 0, zzjc), new C12682(this)));
        } else {
