...
public class zzdg extends zzdd {
    ...
    zzdg(Context context, DataLayer dataLayer, zzdc com_google_android_gms_tagmanager_zzdc) {
        ...
        this.zzaTk.add(AppEventsConstants.EVENT_PARAM_VALUE_NO);
    ...
    private void zza(Tracker tracker, Map<String, zza> map) {
        ...
        if (zzfd == null) {
            zzbg.m1004e("Cannot find transactionId in data layer.");
            return;
        }
            ...
            if (zzfe != null) {
                for (Map map2 : zzfe) {
                    if (map2.get(ShareConstants.WEB_DIALOG_PARAM_NAME) == null) {
                        zzbg.m1004e("Unable to send transaction item hit due to missing 'name' field.");
                        return;
                    }
            ...
            if (obj instanceof List) {
                for (Map map4 : (List) obj) {
                    try {
                        ...
                        zzbg.m1004e("Failed to extract a product from DataLayer. " + e.getMessage());
                    }
                }
            }
            ...
            if (r0 != null) {
                for (Map map42 : r0) {
                    try {
                        ...
                        zzbg.m1004e("Failed to extract a promotion from DataLayer. " + e2.getMessage());
                    }
                }
                                ...
                                if (list != null) {
                                    for (Map map22 : list) {
                                        try {
                                            ...
                                            zzbg.m1004e("Failed to extract a product from DataLayer. " + e3.getMessage());
                                        }
                                    }
                                }
                                try {
                                    ...
                                    zzbg.m1004e("Failed to extract a product action from DataLayer. " + e22.getMessage());
                                }
                            }
                        }
                    }
