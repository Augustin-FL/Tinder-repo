...
class zzcx implements zzac {
    ...
    private void zza(HttpEntityEnclosingRequest httpEntityEnclosingRequest) {
        ...
        if (httpEntityEnclosingRequest.getEntity() != null) {
            try {
                ...
                zzbg.m1005v("Error Writing hit to log...");
            }
        }
        zzbg.m1005v(stringBuffer.toString());
    }
    ...
    private HttpEntityEnclosingRequest zzd(URL url) {
        ...
        try {
            ...
            try {
                basicHttpEntityEnclosingRequest.addHeader(HTTP.USER_AGENT, this.zzaSp);
    ...
    URL zzd(zzaq com_google_android_gms_tagmanager_zzaq) {
        try {
            ...
            zzbg.m1004e("Error trying to parse the GTM url.");
            return null;
        }
    }
        ...
        while (i < min) {
            ...
            if (zzd == null) {
                ...
                if (zzd2 == null) {
                    ...
                    zzd2.addHeader(HTTP.TARGET_HOST, httpHost.toHostString());
                    zza(zzd2);
                    if (obj != null) {
                        try {
    ...
    public boolean zzzX() {
        ...
        zzbg.m1005v("...no network connectivity");
        return false;
    }
}
