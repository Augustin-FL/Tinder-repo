...
class zzat extends Thread implements zzas {
    ...
    class C12491 implements Runnable {
        ...
        C12491(zzat com_google_android_gms_tagmanager_zzat, zzas com_google_android_gms_tagmanager_zzas, long j, String str) {
    ...
    public void run() {
        while (!this.mClosed) {
            try {
                ...
                zzbg.m1004e("Error on Google TagManager Thread: " + zzd(th));
                zzbg.m1004e("Google TagManager is shutting down.");
                this.zzMT = true;
            }
        }
    }
    ...
    void zzh(String str, long j) {
        zzg(new C12491(this, this, j, str));
    }
}
