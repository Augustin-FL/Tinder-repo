...
public final class GoogleAuthUtil {
    ...
    public static void clearToken(Context context, String str) throws GooglePlayServicesAvailabilityException, GoogleAuthException, IOException {
        ...
        if (zzak.zza(zzQI, com_google_android_gms_common_zza, "GoogleAuthUtil")) {
            try {
                Bundle zza = zzau.zza.zza(com_google_android_gms_common_zza.zzmS()).zza(str, bundle);
    ...
    public static List<AccountChangeEvent> getAccountChangeEvents(Context context, int i, String str) throws GoogleAuthException, IOException {
        ...
        if (zzak.zza(zzQI, com_google_android_gms_common_zza, "GoogleAuthUtil")) {
            try {
                List<AccountChangeEvent> events = zzau.zza.zza(com_google_android_gms_common_zza.zzmS()).zza(new AccountChangeEventsRequest().setAccountName(str).setEventIndex(i)).getEvents();
                zzak.zzb(zzQI, com_google_android_gms_common_zza, "GoogleAuthUtil");
                return events;
            } catch (Throwable e) {
                Log.i("GoogleAuthUtil", "GMS remote exception ", e);
    ...
    public static String getTokenWithNotification(Context context, Account account, String str, Bundle bundle) throws IOException, UserRecoverableNotifiedException, GoogleAuthException {
        return zzb(context, account, str, bundle).getString("authtoken");
    }
    ...
    public static String getTokenWithNotification(Context context, Account account, String str, Bundle bundle, Intent intent) throws IOException, UserRecoverableNotifiedException, GoogleAuthException {
        ...
        return zzc(context, account, str, bundle).getString("authtoken");
    }
    ...
    private static boolean zzbB(String str) {
        return NativeProtocol.ERROR_NETWORK_ERROR.equals(str) || "ServiceUnavailable".equals(str) || HttpHeaders.TIMEOUT.equals(str);
    }
