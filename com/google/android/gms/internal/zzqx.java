...
public abstract class zzqx {
    ...
    public void zza(zza com_google_android_gms_internal_zzqx_zza) {
        zzbg.m1004e("ResourceManager: Failed to download a resource: " + com_google_android_gms_internal_zzqx_zza.name());
    ...
    public void zzu(byte[] bArr) {
        ...
        zzbg.m1005v("ResourceManager: Resource downloaded from Network: " + this.zzaUo.getId());
        zzqi com_google_android_gms_internal_zzqi = (zzqi) this.zzaUo.zzBv().get(0);
