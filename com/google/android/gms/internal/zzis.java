...
public class zzis extends WebView implements OnGlobalLayoutListener, DownloadListener, zzip {
    ...
    class C11401 implements Runnable {
        ...
        C11401(zzis com_google_android_gms_internal_zzis) {
    ...
    public void destroy() {
        synchronized (this.zzpc) {
            ...
            zzhn();
            this.zzJn = true;
            zzb.m1002v("Initiating WebView self destruct sequence in 3...");
            this.zzCq.zzhd();
        }
    }
    ...
    protected void onMeasure(int i, int i2) {
        ...
        synchronized (this.zzpc) {
            if (isDestroyed()) {
                ...
                mode = (mode == Action.UNDEFINED_DURATION || mode == 1073741824) ? size : Integer.MAX_VALUE;
                if (mode2 == Action.UNDEFINED_DURATION || mode2 == 1073741824) {
                    i3 = size2;
                }
    ...
    public void zzb(String str, JSONObject jSONObject) {
        ...
        stringBuilder.append(");");
        zzb.m1002v("Dispatching AFMA event: " + stringBuilder.toString());
    ...
    public void zzeD() {
        ...
        hashMap.put(ServerProtocol.FALLBACK_DIALOG_PARAM_VERSION, this.zzpa.zzIz);
        zzc("onshow", hashMap);
    }
    ...
    public void zzgX() {
        synchronized (this.zzpc) {
            zzb.m1002v("Destroying WebView!");
            zzhu.zzHK.post(new C11401(this));
        }
    }
