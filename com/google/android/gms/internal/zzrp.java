...
public final class zzrp {
    ...
    private zzrp(byte[] bArr, int i, int i2) {
        this.zzbbV = ActivityChooserViewAdapter.MAX_ACTIVITY_COUNT_UNLIMITED;
        this.zzbbX = 64;
        this.zzbbY = 67108864;
        this.buffer = bArr;
        this.zzbbQ = i;
    ...
    public String readString() throws IOException {
        int zzDa = zzDa();
        if (zzDa > this.zzbbR - this.zzbbT || zzDa <= 0) {
            return new String(zzlo(zzDa), HTTP.UTF_8);
        }
        String str = new String(this.buffer, this.zzbbT, zzDa, HTTP.UTF_8);
        this.zzbbT = zzDa + this.zzbbT;
        return str;
    }
    ...
    public long zzDb() throws IOException {
        ...
        for (int i = 0; i < 64; i += 7) {
            ...
            if ((zzDh & AccessibilityNodeInfoCompat.ACTION_CLEAR_ACCESSIBILITY_FOCUS) == 0) {
                return j;
            }
        }
        throw zzrw.zzDr();
    ...
    public int zzDc() throws IOException {
        return (((zzDh() & RangeSeekBar.INVALID_POINTER_ID) | ((zzDh() & RangeSeekBar.INVALID_POINTER_ID) << 8)) | ((zzDh() & RangeSeekBar.INVALID_POINTER_ID) << 16)) | ((zzDh() & RangeSeekBar.INVALID_POINTER_ID) << 24);
    }
    ...
    public int zzDf() {
        if (this.zzbbV == ActivityChooserViewAdapter.MAX_ACTIVITY_COUNT_UNLIMITED) {
            return -1;
        }
