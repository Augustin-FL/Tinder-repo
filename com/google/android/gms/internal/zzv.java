...
public class zzv implements zzb {
    ...
    static void zza(OutputStream outputStream, int i) throws IOException {
        outputStream.write((i >> 0) & RangeSeekBar.INVALID_POINTER_ID);
        outputStream.write((i >> 8) & RangeSeekBar.INVALID_POINTER_ID);
        outputStream.write((i >> 16) & RangeSeekBar.INVALID_POINTER_ID);
        outputStream.write((i >> 24) & RangeSeekBar.INVALID_POINTER_ID);
    }
