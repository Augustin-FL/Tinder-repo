...
public final class zzby {
    ...
    static {
        ...
        zzuk = zzbu.zza("gads:video_stream_cache:limit_space", (int) GravityCompat.RELATIVE_LAYOUT_DIRECTION);
        zzul = zzbu.zza("gads:video_stream_exo_cache:buffer_size", (int) GravityCompat.RELATIVE_LAYOUT_DIRECTION);
