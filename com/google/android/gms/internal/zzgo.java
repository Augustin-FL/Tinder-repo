...
public final class zzgo {
    ...
    class C11131 implements zzdg {
        final /* synthetic */ zzgo zzFe;

        C11131(zzgo com_google_android_gms_internal_zzgo) {
    ...
    class C11142 implements zzdg {
        final /* synthetic */ zzgo zzFe;

        C11142(zzgo com_google_android_gms_internal_zzgo) {
            this.zzFe = com_google_android_gms_internal_zzgo;
        }
            ...
            synchronized (this.zzFe.zzpc) {
                ...
                if (this.zzFe.zzBm.equals(com_google_android_gms_internal_zzgq.getRequestId())) {
                    ...
                    if (url.contains("%40mediation_adapters%40")) {
                        ...
                        zzb.m1002v("Ad request URL modified to " + replaceAll);
                    }
                    this.zzFe.zzFa.zzf(com_google_android_gms_internal_zzgq);
                    return;
                }
    ...
    public zzgo(String str, String str2) {
        ...
        this.zzFa = new zzie();
        this.zzFc = new C11131(this);
        this.zzFd = new C11142(this);
        this.zzEZ = str2;
        this.zzBm = str;
    }
