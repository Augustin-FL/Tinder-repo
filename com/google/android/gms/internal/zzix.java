...
public class zzix extends WebViewClient {
    ...
    public void onLoadResource(WebView webView, String str) {
        zzb.zzaC("JavascriptAdWebViewClient::onLoadResource: " + str);
        if (!zzaL(str)) {
    ...
    public void onPageFinished(WebView webView, String str) {
        zzb.zzaC("JavascriptAdWebViewClient::onPageFinished: " + str);
        if (!this.zzJC) {
            this.zzJD.zzfl();
            this.zzJC = true;
        }
    ...
    public boolean shouldOverrideUrlLoading(WebView webView, String str) {
        zzb.zzaC("JavascriptAdWebViewClient::shouldOverrideUrlLoading: " + str);
        if (!zzaL(str)) {
