...
public final class zzof {
    ...
    class C11621 implements Runnable {
        ...
        C11621(zzof com_google_android_gms_internal_zzof, zzob com_google_android_gms_internal_zzob) {
    ...
    private class zza extends ThreadPoolExecutor {
        ...
        class C11631 extends FutureTask<T> {
            final /* synthetic */ zza zzaIk;

            C11631(zza com_google_android_gms_internal_zzof_zza, Runnable runnable, Object obj) {
        ...
        protected <T> RunnableFuture<T> newTaskFor(Runnable runnable, T t) {
            return new C11631(this, runnable, t);
        }
    }
    ...
    private static class zzb implements ThreadFactory {
        ...
        public Thread newThread(Runnable runnable) {
            return new zzc(runnable, "measurement-" + zzaIl.incrementAndGet());
        }
    }
    ...
    void zze(zzob com_google_android_gms_internal_zzob) {
        if (com_google_android_gms_internal_zzob.zzxq()) {
            ...
            zzxh.zzxn();
            this.zzaIg.execute(new C11621(this, zzxh));
        }
    }
