...
public final class zzrq {
    ...
    public void zzaa(long j) throws IOException {
        while ((-128 & j) != 0) {
            zzlu((((int) j) & TransportMediator.KEYCODE_MEDIA_PAUSE) | AccessibilityNodeInfoCompat.ACTION_CLEAR_ACCESSIBILITY_FOCUS);
            j >>>= 7;
        }
        zzlu((int) j);
    }
    ...
    public void zzac(long j) throws IOException {
        zzlu(((int) j) & RangeSeekBar.INVALID_POINTER_ID);
        zzlu(((int) (j >> 8)) & RangeSeekBar.INVALID_POINTER_ID);
        zzlu(((int) (j >> 16)) & RangeSeekBar.INVALID_POINTER_ID);
        zzlu(((int) (j >> 24)) & RangeSeekBar.INVALID_POINTER_ID);
        zzlu(((int) (j >> 32)) & RangeSeekBar.INVALID_POINTER_ID);
        zzlu(((int) (j >> 40)) & RangeSeekBar.INVALID_POINTER_ID);
        zzlu(((int) (j >> 48)) & RangeSeekBar.INVALID_POINTER_ID);
        zzlu(((int) (j >> 56)) & RangeSeekBar.INVALID_POINTER_ID);
    }
    ...
    public void zzlw(int i) throws IOException {
        while ((i & -128) != 0) {
            zzlu((i & TransportMediator.KEYCODE_MEDIA_PAUSE) | AccessibilityNodeInfoCompat.ACTION_CLEAR_ACCESSIBILITY_FOCUS);
            i >>>= 7;
        }
        zzlu(i);
    }
    ...
    public void zzly(int i) throws IOException {
        zzlu(i & RangeSeekBar.INVALID_POINTER_ID);
        zzlu((i >> 8) & RangeSeekBar.INVALID_POINTER_ID);
        zzlu((i >> 16) & RangeSeekBar.INVALID_POINTER_ID);
        zzlu((i >> 24) & RangeSeekBar.INVALID_POINTER_ID);
    }
