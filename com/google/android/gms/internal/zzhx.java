...
public class zzhx {
    ...
    public static class zza {
        ...
        public boolean equals(Object obj) {
            ...
            zza com_google_android_gms_internal_zzhx_zza = (zza) obj;
        ...
        public String toString() {
            return zzw.zzu(this).zzg(ShareConstants.WEB_DIALOG_PARAM_NAME, this.name).zzg("minBound", Double.valueOf(this.zzIa)).zzg("maxBound", Double.valueOf(this.zzHZ)).zzg("percent", Double.valueOf(this.zzIb)).zzg("count", Integer.valueOf(this.count)).toString();
        }
    }
