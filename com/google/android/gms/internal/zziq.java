...
public class zziq extends WebViewClient {
    ...
    class C11391 implements Runnable {
        ...
        C11391(zziq com_google_android_gms_internal_zziq) {
    ...
    public final void onLoadResource(WebView webView, String str) {
        com.google.android.gms.ads.internal.util.client.zzb.m1002v("Loading resource: " + str);
        Uri parse = Uri.parse(str);
    ...
    public final void onPageFinished(WebView webView, String str) {
        synchronized (this.zzpc) {
            if (this.zzJe && "about:blank".equals(str)) {
                com.google.android.gms.ads.internal.util.client.zzb.m1002v("Blank page loaded, 1...");
                this.zzoL.zzgX();
                return;
            }
            this.zzJf = true;
    ...
    public final void onReceivedError(WebView webView, int i, String str, String str2) {
        String valueOf = (i >= 0 || (-i) - 1 >= zzIU.length) ? String.valueOf(i) : zzIU[(-i) - 1];
        zza(this.zzoL.getContext(), "http_err", valueOf, str2);
    ...
    public final void onReceivedSslError(WebView webView, SslErrorHandler sslErrorHandler, SslError sslError) {
        if (sslError != null) {
            ...
            zza(this.zzoL.getContext(), "ssl_err", valueOf, zzp.zzbz().zza(sslError));
        }
    ...
    public boolean shouldOverrideKeyEvent(WebView webView, KeyEvent keyEvent) {
        switch (keyEvent.getKeyCode()) {
            case C3168f.Theme_panelMenuListTheme /*79*/:
            case C3168f.Theme_colorControlActivated /*85*/:
            case C3168f.Theme_colorControlHighlight /*86*/:
            case C3168f.Theme_colorButtonNormal /*87*/:
            case C3168f.Theme_colorSwitchThumbNormal /*88*/:
            case C3168f.Theme_alertDialogStyle /*89*/:
            case C3168f.Theme_alertDialogButtonGroupStyle /*90*/:
            case C3168f.Theme_alertDialogCenterButtons /*91*/:
    ...
    public final boolean shouldOverrideUrlLoading(WebView webView, String str) {
        com.google.android.gms.ads.internal.util.client.zzb.m1002v("AdWebView shouldOverrideUrlLoading: " + str);
        Uri parse = Uri.parse(str);
        if ("gmsg".equalsIgnoreCase(parse.getScheme()) && "mobileads.google.com".equalsIgnoreCase(parse.getHost())) {
            zzh(parse);
    ...
    public final void zzeA() {
        synchronized (this.zzpc) {
            this.zzIZ = false;
            this.zzqL = true;
            zzhu.runOnUiThread(new C11391(this));
        }
    }
    ...
    public void zzh(Uri uri) {
        ...
        if (list != null) {
            ...
            if (com.google.android.gms.ads.internal.util.client.zzb.zzM(2)) {
                com.google.android.gms.ads.internal.util.client.zzb.m1002v("Received GMSG: " + path);
                for (String path2 : zze.keySet()) {
                    com.google.android.gms.ads.internal.util.client.zzb.m1002v("  " + path2 + ": " + ((String) zze.get(path2)));
                }
            }
            for (zzdg zza : list) {
        ...
        com.google.android.gms.ads.internal.util.client.zzb.m1002v("No GMSG handler found for GMSG: " + uri);
    }
    ...
    public void zzhd() {
        synchronized (this.zzpc) {
            com.google.android.gms.ads.internal.util.client.zzb.m1002v("Loading blank page in WebView, 2...");
            this.zzJe = true;
