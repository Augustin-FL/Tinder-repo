...
public class zzdh implements zzdg {
    ...
    class C10521 implements Runnable {
        ...
        class C10511 implements Runnable {
            ...
            final /* synthetic */ C10521 zzwX;

            C10511(C10521 c10521, JSONObject jSONObject) {
                this.zzwX = c10521;
        ...
        C10521(zzdh com_google_android_gms_internal_zzdh, Map map, zzip com_google_android_gms_internal_zzip) {
        ...
        public void run() {
            ...
            if (zzV == null) {
                com.google.android.gms.ads.internal.util.client.zzb.m1001e("Response should not be null.");
            } else {
                zzhu.zzHK.post(new C10511(this, zzV));
            }
        }
    }
    ...
    public JSONObject zzV(String str) {
        try {
            ...
            com.google.android.gms.ads.internal.util.client.zzb.m1001e("The request is not a valid JSON.");
            try {
    ...
    public void zza(zzip com_google_android_gms_internal_zzip, Map<String, String> map) {
        zzht.zza(new C10521(this, map, com_google_android_gms_internal_zzip));
    }
