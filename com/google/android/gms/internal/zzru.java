...
class zzru implements Cloneable {
    ...
    public boolean equals(Object obj) {
        ...
        if (this.zzbci != null && com_google_android_gms_internal_zzru.zzbci != null) {
            return this.zzbch == com_google_android_gms_internal_zzru.zzbch ? !this.zzbch.zzbcb.isArray() ? this.zzbci.equals(com_google_android_gms_internal_zzru.zzbci) : this.zzbci instanceof byte[] ? Arrays.equals((byte[]) this.zzbci, (byte[]) com_google_android_gms_internal_zzru.zzbci) : this.zzbci instanceof int[] ? Arrays.equals((int[]) this.zzbci, (int[]) com_google_android_gms_internal_zzru.zzbci) : this.zzbci instanceof long[] ? Arrays.equals((long[]) this.zzbci, (long[]) com_google_android_gms_internal_zzru.zzbci) : this.zzbci instanceof float[] ? Arrays.equals((float[]) this.zzbci, (float[]) com_google_android_gms_internal_zzru.zzbci) : this.zzbci instanceof double[] ? Arrays.equals((double[]) this.zzbci, (double[]) com_google_android_gms_internal_zzru.zzbci) : this.zzbci instanceof boolean[] ? Arrays.equals((boolean[]) this.zzbci, (boolean[]) com_google_android_gms_internal_zzru.zzbci) : Arrays.deepEquals((Object[]) this.zzbci, (Object[]) com_google_android_gms_internal_zzru.zzbci) : false;
        } else {
