...
public class zzhw {
    ...
    class C11311 implements OnClickListener {
        ...
        C11311(zzhw com_google_android_gms_internal_zzhw, String str) {
            this.zzHT = com_google_android_gms_internal_zzhw;
            this.zzHS = str;
        }

        public void onClick(DialogInterface dialogInterface, int i) {
            this.zzHT.mContext.startActivity(Intent.createChooser(new Intent("android.intent.action.SEND").setType(HTTP.PLAIN_TEXT_TYPE).putExtra("android.intent.extra.TEXT", this.zzHS), "Share via"));
        }
    }

    /* renamed from: com.google.android.gms.internal.zzhw.2 */
    class C11322 implements OnClickListener {
        final /* synthetic */ zzhw zzHT;

        C11322(zzhw com_google_android_gms_internal_zzhw) {
            this.zzHT = com_google_android_gms_internal_zzhw;
        }
    ...
    private void showDialog() {
        if (this.mContext instanceof Activity) {
            ...
            builder.setPositiveButton("Share", new C11311(this, zzaA));
            builder.setNegativeButton(HTTP.CONN_CLOSE, new C11322(this));
            builder.create().show();
            return;
        }
