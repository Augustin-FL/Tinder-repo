...
public class CampaignTrackingService extends Service {
    ...
    class C07531 implements Runnable {
        ...
        C07531(CampaignTrackingService campaignTrackingService, zzaf com_google_android_gms_analytics_internal_zzaf, Handler handler, int i) {
    ...
    class C07542 implements Runnable {
        ...
        C07542(CampaignTrackingService campaignTrackingService, zzaf com_google_android_gms_analytics_internal_zzaf, Handler handler, int i) {
            this.zzKo = campaignTrackingService;
            this.zzKh = com_google_android_gms_analytics_internal_zzaf;
            this.zzt = handler;
            this.zzKf = i;
    ...
    class C07553 implements Runnable {
        ...
        C07553(CampaignTrackingService campaignTrackingService, int i, zzaf com_google_android_gms_analytics_internal_zzaf) {
            this.zzKo = campaignTrackingService;
            this.zzKf = i;
            this.zzKh = com_google_android_gms_analytics_internal_zzaf;
        }
    ...
    public int onStartCommand(Intent intent, int i, int i2) {
        ...
        if (TextUtils.isEmpty(str)) {
            ...
            zzX.zzig().zzf(new C07531(this, zzie, handler, i2));
        } else {
            ...
            zzie.zza("CampaignTrackingService called. startId, campaign", Integer.valueOf(i2), str);
            zzX.zzhz().zza(str, new C07542(this, zzie, handler, i2));
        }
        return 2;
    }

    protected void zza(zzaf com_google_android_gms_analytics_internal_zzaf, Handler handler, int i) {
        handler.post(new C07553(this, i, com_google_android_gms_analytics_internal_zzaf));
    }
}
