...
public final class zzy {
    ...
    static {
        ...
        zzNw = zza.zze("analytics.max_hit_length.k", Utility.DEFAULT_STREAM_BUFFER_SIZE);
        zzNx = zza.zze("analytics.max_post_length.k", Utility.DEFAULT_STREAM_BUFFER_SIZE);
        zzNy = zza.zze("analytics.max_batch_post_length", Utility.DEFAULT_STREAM_BUFFER_SIZE);
