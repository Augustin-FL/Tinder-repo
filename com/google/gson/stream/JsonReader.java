...
public class JsonReader implements Closeable {
    ...
    static class C19801 extends JsonReaderInternalAccess {
        C19801() {
        }
    ...
    static {
        NON_EXECUTE_PREFIX = ")]}'\n".toCharArray();
        JsonReaderInternalAccess.INSTANCE = new C19801();
    }
        ...
        if (i == PEEKED_BEGIN_OBJECT) {
            ...
            switch (nextNonWhitespace(true)) {
                ...
                case C3168f.Theme_toolbarNavigationButtonStyle /*59*/:
                    checkLenient();
                    break;
                case C3168f.Theme_textColorAlertDialogListItem /*93*/:
        ...
        while (true) {
            ...
            switch (c) {
                case C3168f.Theme_dialogPreferredPadding /*43*/:
                    ...
                    obj2 = obj;
                    continue;
                case C3168f.Theme_actionDropDownStyle /*45*/:
                    if (i4 == 0) {
                ...
                case C3168f.Theme_dropdownListPreferredItemHeight /*46*/:
                    ...
                    obj2 = obj;
                    continue;
                case C3168f.Theme_listPreferredItemHeightSmall /*69*/:
        ...
        if (this.pos != this.limit || fillBuffer(PEEKED_BEGIN_OBJECT)) {
            ...
            switch (c) {
                case PEEKED_UNQUOTED /*10*/:
                    ...
                    this.lineStart = this.pos;
                    return c;
                case C3168f.Theme_buttonStyle /*98*/:
                    return '\b';
