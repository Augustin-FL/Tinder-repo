...
public final class Excluder implements TypeAdapterFactory, Cloneable {
    ...
    class C19491 extends TypeAdapter<T> {
        ...
        C19491(boolean z, boolean z2, Gson gson, TypeToken typeToken) {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> typeToken) {
        ...
        if (excludeClass || excludeClass2) {
            return new C19491(excludeClass2, excludeClass, gson, typeToken);
        }
        return null;
    }
