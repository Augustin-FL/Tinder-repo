...
public final class LinkedTreeMap<K, V> extends AbstractMap<K, V> implements Serializable {
    ...
    static class C19531 implements Comparator<Comparable> {
        C19531() {
        }
    ...
    class EntrySet extends AbstractSet<Entry<K, V>> {
        ...
        class C19541 extends LinkedTreeMapIterator<Entry<K, V>> {
            C19541() {
                super(null);
            }
    ...
    final class KeySet extends AbstractSet<K> {
        ...
        class C19551 extends LinkedTreeMapIterator<K> {
            C19551() {
                super(null);
            }
