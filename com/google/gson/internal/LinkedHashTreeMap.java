...
public final class LinkedHashTreeMap<K, V> extends AbstractMap<K, V> implements Serializable {
    ...
    static class C19501 implements Comparator<Comparable> {
        C19501() {
        }
    ...
    final class EntrySet extends AbstractSet<Entry<K, V>> {
        ...
        class C19511 extends LinkedTreeMapIterator<Entry<K, V>> {
            C19511() {
                super(null);
            }
    ...
    final class KeySet extends AbstractSet<K> {
        ...
        class C19521 extends LinkedTreeMapIterator<K> {
            C19521() {
                super(null);
            }
