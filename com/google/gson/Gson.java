...
public final class Gson {
    ...
    class C19311 implements JsonDeserializationContext {
        C19311() {
        }
    ...
    class C19322 implements JsonSerializationContext {
        C19322() {
        }
    ...
    class C19333 extends TypeAdapter<Number> {
        C19333() {
        }
    ...
    class C19344 extends TypeAdapter<Number> {
        C19344() {
        }
    ...
    class C19355 extends TypeAdapter<Number> {
        C19355() {
        }
    ...
    Gson(Excluder excluder, FieldNamingStrategy fieldNamingStrategy, Map<Type, InstanceCreator<?>> map, boolean z, boolean z2, boolean z3, boolean z4, boolean z5, boolean z6, LongSerializationPolicy longSerializationPolicy, List<TypeAdapterFactory> list) {
        ...
        this.deserializationContext = new C19311();
        this.serializationContext = new C19322();
