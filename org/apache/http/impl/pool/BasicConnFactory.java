...
public class BasicConnFactory implements ConnFactory<HttpHost, HttpClientConnection> {
    ...
    protected HttpClientConnection create(Socket socket, HttpParams httpParams) throws IOException {
        HttpClientConnection defaultBHttpClientConnection = new DefaultBHttpClientConnection(httpParams.getIntParameter(CoreConnectionPNames.SOCKET_BUFFER_SIZE, Utility.DEFAULT_STREAM_BUFFER_SIZE));
