...
class OpReorderer {
    ...
    void swapMoveRemove(List<UpdateOp> list, int i, UpdateOp updateOp, int i2, UpdateOp updateOp2) {
        ...
        if (updateOp.positionStart <= updateOp2.positionStart) {
            ...
            updateOp3 = this.mCallback.obtainUpdateOp(1, updateOp.positionStart + 1, (updateOp2.positionStart + updateOp2.itemCount) - updateOp.positionStart);
    ...
    void swapMoveUpdate(List<UpdateOp> list, int i, UpdateOp updateOp, int i2, UpdateOp updateOp2) {
        ...
        if (updateOp.itemCount < updateOp2.positionStart) {
            ...
            updateOp2.itemCount--;
            obj = this.mCallback.obtainUpdateOp(2, updateOp.positionStart, 1);
        } else {
            obj = null;
        }
        if (updateOp.positionStart <= updateOp2.positionStart) {
            ...
            obj2 = this.mCallback.obtainUpdateOp(2, updateOp.positionStart + 1, i3);
