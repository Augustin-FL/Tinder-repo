...
public class ItemTouchHelper extends ItemDecoration implements OnChildAttachStateChangeListener {
    ...
    class C02812 implements OnItemTouchListener {
        C02812() {
        }
    ...
    private class RecoverAnimation implements AnimatorListenerCompat {
        ...
        class C02871 implements AnimatorUpdateListenerCompat {
            final /* synthetic */ ItemTouchHelper val$this$0;

            C02871(ItemTouchHelper itemTouchHelper) {
        ...
        public RecoverAnimation(ViewHolder viewHolder, int i, int i2, float f, float f2, float f3, float f4) {
            ...
            this.mValueAnimator.addUpdateListener(new C02871(ItemTouchHelper.this));
    ...
    class C02823 extends RecoverAnimation {
        final /* synthetic */ ViewHolder val$prevSelected;
        final /* synthetic */ int val$swipeDir;

        C02823(ViewHolder viewHolder, int i, int i2, float f, float f2, float f3, float f4, int i3, ViewHolder viewHolder2) {
    ...
    class C02834 implements Runnable {
        ...
        C02834(RecoverAnimation recoverAnimation, int i) {
    ...
    class C02845 implements ChildDrawingOrderCallback {
        C02845() {
        }
    ...
    public static abstract class Callback {
        ...
        static class C02851 implements Interpolator {
            C02851() {
            }
        ...
        static class C02862 implements Interpolator {
            C02862() {
            }
        ...
        static {
            sDragScrollInterpolator = new C02851();
            sDragViewScrollCapInterpolator = new C02862();
        ...
        private int getMaxDragScroll(RecyclerView recyclerView) {
            if (this.mCachedMaxScrollSpeed == ItemTouchHelper.ACTIVE_POINTER_ID_NONE) {
                this.mCachedMaxScrollSpeed = recyclerView.getResources().getDimensionPixelSize(C0221R.dimen.item_touch_helper_max_drag_scroll_per_frame);
            }
        ...
        if (viewHolder != this.mSelected || i != this.mActionState) {
            ...
            if (this.mSelected != null) {
                ...
                if (viewHolder2.itemView.getParent() != null) {
                    ...
                    RecoverAnimation c02823 = new C02823(viewHolder2, i4, i2, f2, f3, f, signum, swipeIfNecessary, viewHolder2);
                    c02823.setDuration(this.mCallback.getAnimationDuration(this.mRecyclerView, i4, f - f2, signum - f3));
                    this.mRecoverAnimations.add(c02823);
                    c02823.start();
                    obj = UP;
                } else {
    ...
    private void postDispatchSwipe(RecoverAnimation recoverAnimation, int i) {
        this.mRecyclerView.post(new C02834(recoverAnimation, i));
    }
    ...
    private int checkHorizontalSwipe(ViewHolder viewHolder, int i) {
        ...
        if ((i & 12) != 0) {
            ...
            if (this.mVelocityTracker != null && this.mActivePointerId > ACTIVE_POINTER_ID_NONE) {
                ...
                if ((i2 & i) != 0 && i3 == i2 && Math.abs(xVelocity) >= ((float) this.mRecyclerView.getMinFlingVelocity())) {
                    return i2;
                }
            }
    ...
    private int checkVerticalSwipe(ViewHolder viewHolder, int i) {
        ...
        if ((i & 3) != 0) {
            ...
            if (this.mVelocityTracker != null && this.mActivePointerId > ACTIVE_POINTER_ID_NONE) {
                ...
                if ((i2 & i) != 0 && i2 == i3 && Math.abs(yVelocity) >= ((float) this.mRecyclerView.getMinFlingVelocity())) {
                    return i2;
                }
            }
    ...
    private void addChildDrawingOrderCallback() {
        if (VERSION.SDK_INT < 21) {
            if (this.mChildDrawingOrderCallback == null) {
                this.mChildDrawingOrderCallback = new C02845();
            }
