...
public class DefaultItemAnimator extends ItemAnimator {
    ...
    class C02314 extends VpaListenerAdapter {
        final /* synthetic */ ViewPropertyAnimatorCompat val$animation;
        final /* synthetic */ ViewHolder val$holder;

        C02314(ViewHolder viewHolder, ViewPropertyAnimatorCompat viewPropertyAnimatorCompat) {
    ...
    class C02325 extends VpaListenerAdapter {
        final /* synthetic */ ViewPropertyAnimatorCompat val$animation;
        final /* synthetic */ ViewHolder val$holder;

        C02325(ViewHolder viewHolder, ViewPropertyAnimatorCompat viewPropertyAnimatorCompat) {
            this.val$holder = viewHolder;
            this.val$animation = viewPropertyAnimatorCompat;
            super();
        }
    ...
    class C02336 extends VpaListenerAdapter {
        final /* synthetic */ ViewPropertyAnimatorCompat val$animation;
        final /* synthetic */ int val$deltaX;
        final /* synthetic */ int val$deltaY;
        final /* synthetic */ ViewHolder val$holder;

        C02336(ViewHolder viewHolder, int i, int i2, ViewPropertyAnimatorCompat viewPropertyAnimatorCompat) {
            this.val$holder = viewHolder;
            this.val$deltaX = i;
            this.val$deltaY = i2;
            this.val$animation = viewPropertyAnimatorCompat;
    ...
    class C02347 extends VpaListenerAdapter {
        final /* synthetic */ ChangeInfo val$changeInfo;
        final /* synthetic */ ViewPropertyAnimatorCompat val$oldViewAnim;

        C02347(ChangeInfo changeInfo, ViewPropertyAnimatorCompat viewPropertyAnimatorCompat) {
    ...
    class C02358 extends VpaListenerAdapter {
        final /* synthetic */ ChangeInfo val$changeInfo;
        final /* synthetic */ View val$newView;
        final /* synthetic */ ViewPropertyAnimatorCompat val$newViewAnimation;

        C02358(ChangeInfo changeInfo, ViewPropertyAnimatorCompat viewPropertyAnimatorCompat, View view) {
            this.val$changeInfo = changeInfo;
    ...
    public void runPendingAnimations() {
        ...
        if (i4 != 0 || i != 0 || i3 != 0 || i2 != 0) {
            ...
            if (i != 0) {
                ...
                c02281 = new C02281(arrayList);
                if (i4 != 0) {
                    ViewCompat.postOnAnimationDelayed(((MoveInfo) arrayList.get(0)).holder.itemView, c02281, getRemoveDuration());
                } else {
                    c02281.run();
                }
            }
            if (i2 != 0) {
                ...
                c02281 = new C02292(arrayList);
                if (i4 != 0) {
                    ViewCompat.postOnAnimationDelayed(((ChangeInfo) arrayList.get(0)).oldHolder.itemView, c02281, getRemoveDuration());
                } else {
                    c02281.run();
                }
            }
            if (i3 != 0) {
                ...
                Runnable c02303 = new C02303(arrayList2);
                if (i4 == 0 && i == 0 && i2 == 0) {
                    c02303.run();
                    return;
                }
                ...
                ViewCompat.postOnAnimationDelayed(((ViewHolder) arrayList2.get(0)).itemView, c02303, removeDuration + Math.max(moveDuration, changeDuration));
            }
        }
    }
    ...
    private void animateRemoveImpl(ViewHolder viewHolder) {
        ...
        animate.setDuration(getRemoveDuration()).alpha(0.0f).setListener(new C02314(viewHolder, animate)).start();
    }
    ...
    private void animateAddImpl(ViewHolder viewHolder) {
        ...
        animate.alpha(1.0f).setDuration(getAddDuration()).setListener(new C02325(viewHolder, animate)).start();
    }
    ...
    private void animateMoveImpl(ViewHolder viewHolder, int i, int i2, int i3, int i4) {
        ...
        animate.setDuration(getMoveDuration()).setListener(new C02336(viewHolder, i5, i6, animate)).start();
    }
    ...
    private void animateChangeImpl(ChangeInfo changeInfo) {
        ...
        if (view2 != null) {
            ...
            duration.alpha(0.0f).setListener(new C02347(changeInfo, duration)).start();
        }
        if (view != null) {
            duration = ViewCompat.animate(view);
            this.mChangeAnimations.add(changeInfo.newHolder);
            duration.translationX(0.0f).translationY(0.0f).setDuration(getChangeDuration()).alpha(1.0f).setListener(new C02358(changeInfo, duration, view)).start();
        }
    }
