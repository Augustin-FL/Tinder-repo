...
public class ActionMenuView extends LinearLayoutCompat implements C0171b, C0172m {
    ...
    private class ActionMenuPresenterCallback implements C0156a {
    ...
    private class MenuBuilderCallback implements C0151a {
        ...
        public void onMenuModeChange(C0180f c0180f) {
            if (ActionMenuView.this.mMenuBuilderCallback != null) {
                ActionMenuView.this.mMenuBuilderCallback.onMenuModeChange(c0180f);
            }
        }
    }
    ...
    private void onMeasureExactFormat(int i, int i2) {
        ...
        while (i9 < childCount) {
            ...
            if (childAt.getVisibility() == 8) {
                ...
                layoutParams.leftMargin = 0;
                layoutParams.rightMargin = 0;
                boolean z2 = z && ((ActionMenuItemView) childAt).m72b();
    ...
    static int measureChildForCells(View view, int i, int i2, int i3, int i4) {
        ...
        if (actionMenuItemView == null || !actionMenuItemView.m72b()) {
            z = false;
        } else {
            z = true;
        }
        if (i2 <= 0 || (z && i2 < 2)) {
            ...
            view.measure(MeasureSpec.makeMeasureSpec(i * i2, Action.UNDEFINED_DURATION), makeMeasureSpec);
    ...
    public boolean invokeItem(C0183h c0183h) {
        return this.mMenu.m122a((MenuItem) c0183h, 0);
    }
    ...
    public Menu getMenu() {
        if (this.mMenu == null) {
            ...
            this.mMenu.m114a(new MenuBuilderCallback());
            this.mPresenter = new ActionMenuPresenter(context);
            this.mPresenter.setReserveOverflow(true);
            this.mPresenter.setCallback(this.mActionMenuPresenterCallback != null ? this.mActionMenuPresenterCallback : new ActionMenuPresenterCallback());
            this.mMenu.m117a(this.mPresenter, this.mPopupContext);
            this.mPresenter.setMenuView(this);
        }
        return this.mMenu;
    }
