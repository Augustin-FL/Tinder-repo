...
public class LinearLayoutManager extends LayoutManager implements ViewDropHandler {
    ...
    class C02461 extends LinearSmoothScroller {
    ...
    static class LayoutState {
        ...
        public void assignPositionFromScrapList(ViewHolder viewHolder) {
            ViewHolder nextViewHolderInLimitedList = nextViewHolderInLimitedList(viewHolder);
            this.mCurrentPosition = nextViewHolderInLimitedList == null ? LAYOUT_START : nextViewHolderInLimitedList.getLayoutPosition();
        }

        public ViewHolder nextViewHolderInLimitedList(ViewHolder viewHolder) {
            int size = this.mScrapList.size();
            ...
            while (i2 < size) {
                ...
                ViewHolder viewHolder4 = (ViewHolder) this.mScrapList.get(i2);
                if (viewHolder4 != viewHolder) {
                    if (viewHolder4.isRemoved()) {
                        i3 = i;
                        viewHolder3 = viewHolder2;
                    } else {
                        int layoutPosition = (viewHolder4.getLayoutPosition() - this.mCurrentPosition) * this.mItemDirection;
                        if (layoutPosition < 0) {
                            i3 = i;
                            viewHolder3 = viewHolder2;
    ...
    public void smoothScrollToPosition(RecyclerView recyclerView, State state, int i) {
        SmoothScroller c02461 = new C02461(recyclerView.getContext());
        c02461.setTargetPosition(i);
        startSmoothScroll(c02461);
    }
