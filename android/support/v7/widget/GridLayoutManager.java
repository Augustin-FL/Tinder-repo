...
public class GridLayoutManager extends LinearLayoutManager {
    ...
    void layoutChunk(Recycler recycler, State state, LayoutState layoutState, LayoutChunkResult layoutChunkResult) {
        ...
        while (spanSize < i) {
            ...
            if (this.mOrientation == 1) {
                measureChildWithDecorationsAndMargin(view, makeMeasureSpec, getMainDirSpec(layoutParams.height));
            } else {
                measureChildWithDecorationsAndMargin(view, getMainDirSpec(layoutParams.width), makeMeasureSpec);
            }
        ...
        for (spanSize = MAIN_DIR_SPEC; spanSize < i; spanSize++) {
            ...
            if (this.mOrientationHelper.getDecoratedMeasurement(view2) != i4) {
                ...
                if (this.mOrientation == 1) {
                    measureChildWithDecorationsAndMargin(view2, i3, i2);
                } else {
                    measureChildWithDecorationsAndMargin(view2, i2, i3);
                }
            }
        }
    ...
    private int updateSpecWithExtra(int i, int i2, int i3) {
        ...
        if (mode == Action.UNDEFINED_DURATION || mode == 1073741824) {
