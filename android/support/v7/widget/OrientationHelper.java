...
public abstract class OrientationHelper {
    ...
    static class C02511 extends OrientationHelper {
        C02511(LayoutManager layoutManager) {
            super(null);
        }
    ...
    static class C02522 extends OrientationHelper {
        C02522(LayoutManager layoutManager) {
            super(null);
        }
