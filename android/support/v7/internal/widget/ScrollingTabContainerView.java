...
public class ScrollingTabContainerView extends HorizontalScrollView implements OnItemClickListener {
    ...
    private class TabView extends LinearLayoutCompat implements OnLongClickListener {
        ...
        public TabView(Context context, Tab tab, boolean z) {
            super(context, null, C0159R.attr.actionBarTabStyle);
            this.BG_ATTRS = new int[]{16842964};
            this.mTab = tab;
            TintTypedArray obtainStyledAttributes = TintTypedArray.obtainStyledAttributes(context, null, this.BG_ATTRS, C0159R.attr.actionBarTabStyle, 0);
        ...
        public void update() {
            ...
            if (z) {
                if (this.mTextView == null) {
                    imageView = new AppCompatTextView(getContext(), null, C0159R.attr.actionBarTabTextStyle);
    ...
    private LinearLayoutCompat createTabLayout() {
        LinearLayoutCompat linearLayoutCompat = new LinearLayoutCompat(getContext(), null, C0159R.attr.actionBarTabBarStyle);
    ...
    private SpinnerCompat createSpinner() {
        SpinnerCompat spinnerCompat = new SpinnerCompat(getContext(), null, C0159R.attr.actionDropDownStyle);
    ...
    public void animateToTab(int i) {
        ...
        this.mTabSelector = new C02111(childAt);
