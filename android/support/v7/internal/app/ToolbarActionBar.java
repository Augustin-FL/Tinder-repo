...
public class ToolbarActionBar extends ActionBar {
    ...
    private C0179e mListMenuPresenter;
    ...
    class C01632 implements OnMenuItemClickListener {
        C01632() {
        }
    ...
    private final class ActionMenuPresenterCallback implements C0156a {
        ...
        public boolean onOpenSubMenu(C0180f c0180f) {
            ...
            ToolbarActionBar.this.mWindowCallback.onMenuOpened(8, c0180f);
            return true;
        }
        ...
        public void onCloseMenu(C0180f c0180f, boolean z) {
            if (!this.mClosingActionMenu) {
                ...
                if (ToolbarActionBar.this.mWindowCallback != null) {
                    ToolbarActionBar.this.mWindowCallback.onPanelClosed(8, c0180f);
                }
    ...
    private final class MenuBuilderCallback implements C0151a {
        ...
        public void onMenuModeChange(C0180f c0180f) {
            ...
            if (ToolbarActionBar.this.mDecorToolbar.isOverflowMenuShowing()) {
                ToolbarActionBar.this.mWindowCallback.onPanelClosed(8, c0180f);
            } else if (ToolbarActionBar.this.mWindowCallback.onPreparePanel(0, null, c0180f)) {
                ToolbarActionBar.this.mWindowCallback.onMenuOpened(8, c0180f);
            }
        }
    }
    ...
    private final class PanelMenuPresenterCallback implements C0156a {
        ...
        public void onCloseMenu(C0180f c0180f, boolean z) {
            if (ToolbarActionBar.this.mWindowCallback != null) {
                ToolbarActionBar.this.mWindowCallback.onPanelClosed(0, c0180f);
            }
        }

        public boolean onOpenSubMenu(C0180f c0180f) {
            if (c0180f == null && ToolbarActionBar.this.mWindowCallback != null) {
                ToolbarActionBar.this.mWindowCallback.onMenuOpened(0, c0180f);
            }
            return true;
        }
    }
    ...
    public ToolbarActionBar(Toolbar toolbar, CharSequence charSequence, Callback callback) {
        ...
        this.mMenuInvalidator = new C01621();
        this.mMenuClicker = new C01632();
    ...
    void populateOptionsMenu() {
        Menu menu = getMenu();
        C0180f c0180f = menu instanceof C0180f ? (C0180f) menu : null;
        if (c0180f != null) {
            c0180f.m140g();
        }
        try {
    ...
    private View getListMenuView(Menu menu) {
        ...
        if (menu == null || this.mListMenuPresenter == null || this.mListMenuPresenter.m91a().getCount() <= 0) {
            return null;
        }
        return (View) this.mListMenuPresenter.m90a(this.mDecorToolbar.getViewGroup());
    }

    private void ensureListMenuPresenter(Menu menu) {
        if (this.mListMenuPresenter == null && (menu instanceof C0180f)) {
            C0180f c0180f = (C0180f) menu;
            ...
            this.mListMenuPresenter = new C0179e(contextThemeWrapper, C0159R.layout.abc_list_menu_item_layout);
            this.mListMenuPresenter.m93a(new PanelMenuPresenterCallback());
            c0180f.m116a(this.mListMenuPresenter);
        }
    }
