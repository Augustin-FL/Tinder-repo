...
class C0194o extends C0177c<SupportMenu> implements Menu {
    C0194o(Context context, SupportMenu supportMenu) {
        super(context, supportMenu);
    }

    public MenuItem add(CharSequence charSequence) {
        return m82a(((SupportMenu) this.b).add(charSequence));
    }

    public MenuItem add(int i) {
        return m82a(((SupportMenu) this.b).add(i));
    }

    public MenuItem add(int i, int i2, int i3, CharSequence charSequence) {
        return m82a(((SupportMenu) this.b).add(i, i2, i3, charSequence));
    }

    public MenuItem add(int i, int i2, int i3, int i4) {
        return m82a(((SupportMenu) this.b).add(i, i2, i3, i4));
    }

    public SubMenu addSubMenu(CharSequence charSequence) {
        return m83a(((SupportMenu) this.b).addSubMenu(charSequence));
    }

    public SubMenu addSubMenu(int i) {
        return m83a(((SupportMenu) this.b).addSubMenu(i));
    }

    public SubMenu addSubMenu(int i, int i2, int i3, CharSequence charSequence) {
        return m83a(((SupportMenu) this.b).addSubMenu(i, i2, i3, charSequence));
    }

    public SubMenu addSubMenu(int i, int i2, int i3, int i4) {
        return m83a(((SupportMenu) this.b).addSubMenu(i, i2, i3, i4));
    }
    ...
    public int addIntentOptions(int i, int i2, int i3, ComponentName componentName, Intent[] intentArr, Intent intent, int i4, MenuItem[] menuItemArr) {
        ...
        if (menuItemArr2 != null) {
            ...
            for (int i5 = 0; i5 < length; i5++) {
                menuItemArr[i5] = m82a(menuItemArr2[i5]);
            }
        }
    ...
    public MenuItem findItem(int i) {
        return m82a(((SupportMenu) this.b).findItem(i));
    }
    ...
    public MenuItem getItem(int i) {
        return m82a(((SupportMenu) this.b).getItem(i));
    }
