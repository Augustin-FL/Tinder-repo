...
class MaterialProgressDrawable extends Drawable implements Animatable {
    ...
    private static class Ring {
        ...
        public void draw(Canvas canvas, Rect rect) {
            ...
            if (this.mAlpha < RangeSeekBar.INVALID_POINTER_ID) {
    ...
    private int evaluateColorChange(float f, int i, int i2) {
        ...
        int i3 = (intValue >> 24) & RangeSeekBar.INVALID_POINTER_ID;
        int i4 = (intValue >> 16) & RangeSeekBar.INVALID_POINTER_ID;
        int i5 = (intValue >> 8) & RangeSeekBar.INVALID_POINTER_ID;
        intValue &= RangeSeekBar.INVALID_POINTER_ID;
        int intValue2 = Integer.valueOf(i2).intValue();
        return (intValue + ((int) (((float) ((intValue2 & RangeSeekBar.INVALID_POINTER_ID) - intValue)) * f))) | ((((i3 + ((int) (((float) (((intValue2 >> 24) & RangeSeekBar.INVALID_POINTER_ID) - i3)) * f))) << 24) | ((i4 + ((int) (((float) (((intValue2 >> 16) & RangeSeekBar.INVALID_POINTER_ID) - i4)) * f))) << 16)) | ((((int) (((float) (((intValue2 >> 8) & RangeSeekBar.INVALID_POINTER_ID) - i5)) * f)) + i5) << 8));
    }
    ...
    private void setupAnimators() {
        Ring ring = this.mRing;
        Animation c01241 = new C01241(ring);
        c01241.setRepeatCount(-1);
        c01241.setRepeatMode(DEFAULT);
        c01241.setInterpolator(LINEAR_INTERPOLATOR);
        c01241.setAnimationListener(new C01252(ring));
        this.mAnimation = c01241;
    }
}
