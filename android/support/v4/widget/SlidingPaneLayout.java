...
public class SlidingPaneLayout extends ViewGroup {
    ...
    protected void onMeasure(int i, int i2) {
        ...
        } else if (mode == Action.UNDEFINED_DURATION) {
            i3 = mode2;
            i4 = size;
            size = size2;
        } else {
        ...
        while (i6 < childCount) {
            ...
            if (childAt.getVisibility() == 8) {
                ...
                if (layoutParams.width == -2) {
                    mode = MeasureSpec.makeMeasureSpec(paddingLeft - mode, Action.UNDEFINED_DURATION);
                ...
                if (layoutParams.height == -2) {
                    i5 = MeasureSpec.makeMeasureSpec(mode2, Action.UNDEFINED_DURATION);
                        ...
                        if (!z || childAt2 == this.mSlideableView) {
                            if (layoutParams.weight > 0.0f) {
                                if (layoutParams.width != 0) {
                                    ...
                                    mode = MeasureSpec.makeMeasureSpec(mode2, Action.UNDEFINED_DURATION);
                                } else if (layoutParams.height == -1) {
                            ...
                            if (obj == null) {
                                ...
                                size2 = MeasureSpec.makeMeasureSpec(mode2, Action.UNDEFINED_DURATION);
                            } else if (layoutParams.height == -1) {
