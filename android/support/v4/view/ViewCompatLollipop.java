...
class ViewCompatLollipop {
    ...
    static class C01011 implements OnApplyWindowInsetsListener {
        final /* synthetic */ OnApplyWindowInsetsListener val$listener;

        C01011(OnApplyWindowInsetsListener onApplyWindowInsetsListener) {
    ...
    public static void setOnApplyWindowInsetsListener(View view, OnApplyWindowInsetsListener onApplyWindowInsetsListener) {
        view.setOnApplyWindowInsetsListener(new C01011(onApplyWindowInsetsListener));
    }
