...
class ViewPropertyAnimatorCompatICS {
    ...
    public static void m61x(View view, float f) {
        view.animate().x(f);
    }
    ...
    public static void m62y(View view, float f) {
        view.animate().y(f);
    }
    ...
    public static void setListener(View view, ViewPropertyAnimatorListener viewPropertyAnimatorListener) {
        if (viewPropertyAnimatorListener != null) {
            view.animate().setListener(new C01071(viewPropertyAnimatorListener, view));
        } else {
