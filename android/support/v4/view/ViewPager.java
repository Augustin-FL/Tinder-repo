...
public class ViewPager extends ViewGroup {
    ...
    static class C01021 implements Comparator<ItemInfo> {
        C01021() {
        }
    ...
    static class C01032 implements Interpolator {
        C01032() {
        }
    ...
    public static class SavedState extends BaseSavedState {
        ...
        static {
            CREATOR = ParcelableCompat.newCreator(new C01051());
        }
    ...
    static {
        ...
        LAYOUT_ATTRS = iArr;
        COMPARATOR = new C01021();
        sInterpolator = new C01032();
    ...
    public ViewPager(Context context) {
        ...
        this.mEndScrollRunnable = new C01043();
