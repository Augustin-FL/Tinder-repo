...
public class PagerTitleStrip extends ViewGroup implements Decor {
    ...
    public void setNonPrimaryAlpha(float f) {
        this.mNonPrimaryAlpha = ((int) (255.0f * f)) & RangeSeekBar.INVALID_POINTER_ID;
    ...
    void updateText(int i, PagerAdapter pagerAdapter) {
        ...
        count = MeasureSpec.makeMeasureSpec((int) (((float) ((getWidth() - getPaddingLeft()) - getPaddingRight())) * 0.8f), Action.UNDEFINED_DURATION);
        height = MeasureSpec.makeMeasureSpec(height, Action.UNDEFINED_DURATION);
    ...
    protected void onMeasure(int i, int i2) {
        ...
        int makeMeasureSpec = MeasureSpec.makeMeasureSpec((int) (((float) size) * 0.8f), Action.UNDEFINED_DURATION);
        i3 = MeasureSpec.makeMeasureSpec(i3, Action.UNDEFINED_DURATION);
