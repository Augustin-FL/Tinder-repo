...
public class MediaSessionCompat {
    ...
    static class MediaSessionImplBase implements MediaSessionImpl {
        ...
        class C00701 extends android.support.v4.media.VolumeProviderCompat.Callback {
            C00701() {
            }
        ...
        class C00712 implements android.support.v4.media.session.MediaSessionCompatApi14.Callback {
            final /* synthetic */ Callback val$callback;

            C00712(Callback callback) {
        ...
        public MediaSessionImplBase(Context context, String str, ComponentName componentName, PendingIntent pendingIntent) {
            ...
            this.mVolumeCallback = new C00701();
        ...
        public void setCallback(Callback callback, Handler handler) {
            if (callback != this.mCallback) {
                if (callback == null || VERSION.SDK_INT < 18) {
                    ...
                    android.support.v4.media.session.MediaSessionCompatApi14.Callback c00712 = new C00712(callback);
                    if (VERSION.SDK_INT >= 18) {
                        MediaSessionCompatApi18.setOnPlaybackPositionUpdateListener(this.mRccObj, MediaSessionCompatApi18.createPlaybackPositionUpdateListener(c00712));
                    }
                    if (VERSION.SDK_INT >= 19) {
                        MediaSessionCompatApi19.setOnMetadataUpdateListener(this.mRccObj, MediaSessionCompatApi19.createMetadataUpdateListener(c00712));
                    }
                }
    ...
    public static final class QueueItem implements Parcelable {
        ...
        static class C00721 implements Creator<QueueItem> {
            C00721() {
            }
    ...
    static final class ResultReceiverWrapper implements Parcelable {
        ...
        static class C00731 implements Creator<ResultReceiverWrapper> {
            C00731() {
            }
    ...
    public static final class Token implements Parcelable {
        ...
        static class C00741 implements Creator<Token> {
            C00741() {
            }
