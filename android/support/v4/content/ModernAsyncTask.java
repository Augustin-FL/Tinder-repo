...
abstract class ModernAsyncTask<Params, Progress, Result> {
    ...
    static class C00531 implements ThreadFactory {
    ...
    class C00553 extends FutureTask<Result> {
        C00553(Callable callable) {
            super(callable);
        }
    ...
    public ModernAsyncTask() {
        ...
        this.mWorker = new C00542();
        this.mFuture = new C00553(this.mWorker);
    }
    ...
    public final ModernAsyncTask<Params, Progress, Result> executeOnExecutor(Executor executor, Params... paramsArr) {
        if (this.mStatus != Status.PENDING) {
            switch (C00564.$SwitchMap$android$support$v4$content$ModernAsyncTask$Status[this.mStatus.ordinal()]) {
